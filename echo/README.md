...
参考书籍百万在线写的 sunnet，业务逻辑也用 c++ 写，不用 lua，测出来的结果很惊人
...
server-cs_stat:
  CPU：平均 16.2%，峰值 45.9%，P99 45.9%
  内存：平均 45.4 MB，峰值 53.0 MB
  磁盘：读 0.0 KB/s，写 0.0 KB/s
  网络：收 124.5 KB/s，发 174.8 KB/s
  上下文切换：平均 473823.9 次/s，峰值 871761.0 次/s
  线程数：平均 17.5，最小 9，最大 18


server-go_stat:
  CPU：平均 6.4%，峰值 16.9%，P99 16.9%
  内存：平均 23.8 MB，峰值 27.0 MB
  磁盘：读 0.0 KB/s，写 0.0 KB/s
  网络：收 120.2 KB/s，发 173.5 KB/s
  上下文切换：平均 51514.7 次/s，峰值 94639.0 次/s
  线程数：平均 9.1，最小 6，最大 10


server-cpp_stat:
  CPU：平均 36.4%，峰值 107.9%，P99 107.9%
  内存：平均 2.7 MB，峰值 6.0 MB
  磁盘：读 0.0 KB/s，写 0.0 KB/s
  网络：收 1759.3 KB/s，发 1616.0 KB/s
  上下文切换：平均 27730.3 次/s，峰值 35159.0 次/s
  线程数：平均 3.0，最小 3，最大 3

server-sunnet_stat:
  CPU：平均 0.3%，峰值 1.4%，P99 1.4%
  内存：平均 2.7 MB，峰值 5.0 MB
  磁盘：读 0.0 KB/s，写 0.0 KB/s
  网络：收 0.7 KB/s，发 8.0 KB/s
  上下文切换：平均 682.9 次/s，峰值 1096.0 次/s
  线程数：平均 6.0，最小 6，最大 6


=== 结论（自动推断） ===
CPU 利用率最低：server-sunnet_stat（平均 0.3%）
内存占用最低：server-sunnet_stat（平均 2.7 MB）
锁竞争最少（ctx 切换最低）：server-sunnet_stat（平均 682.9 次/s）
```
...
```sh
# 服务端
./benchmark.sh -n server-go -i bruce48li/cyberbullfight-server-go -d 60
# 客户端
./benchmark.sh -n client-go -i bruce48li/cyberbullfight-client-go -e "SERVER_HOST=172.20.3.111" -e "COUNT=100" -d 60
```